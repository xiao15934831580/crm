  ...
  <div class="tablestyle">
    <div class="search">
      <el-col :span="3">
        <el-input
          class="w-10 m-2"
          v-model="searchvalue"
          placeholder="请输入报修单号/车辆编号/车牌号/维修人员姓名"
        />
      </el-col>
    ...
    <div class="chartstyle">
      ...
      >
        ...
        <el-table-column fixed prop="carCode" label="车辆编号"  min-width="9%" >
          <template #default="scope">
            <el-popover
              placement="top-start"
              trigger="hover"
        ...
        <el-table-column prop="createdDate" label="报修时间"  min-width="17%" >
          <template #default="scope">
            <el-popover
              placement="top-start"
              :width="200"
        ...
        <el-table-column prop="faultType" label="故障分类"  min-width="15%" >
        ...
        >
          <template #default="menuLblScope">
            <el-popover
              ...
              :width="200"
              trigger="hover"
              :content="menuLblScope.row.repairStartDate"
            >
              <template #reference>
                <span class="elispice">{{
                  menuLblScope.row.repairStartDate}}</span>
              </template>
            </el-popover>
          </template>
        </el-table-column>
        ...
        <template #default="menuLblScope">
            <el-popover
              ...
              :width="200"
              trigger="hover"
              :content="menuLblScope.row.repairEndDate"
            >
              <template #reference>
                <span class="elispice">{{
                  menuLblScope.row.repairEndDate}}</span>
              </template>
            </el-popover>
          </template>
        </el-table-column>
        <el-table-column  prop="manHour" label="维修工时" min-width="10%">
          <template #default="scope">
            <el-popover
              placement="top-start"
              :width="100"
              trigger="hover"
              :content="scope.row.manHour"
            >
              <template #reference>
                <span class="elispice" >{{
                  scope.row.manHour}}</span>
              </template>
            </el-popover>
          </template>
        </el-table-column>
...
import { getRepAll as getRepAll,queryRep as queryRep } from '@/api/index'
...
let tableData = [
  {
    ...
    carCode: "001",
    carNumber: "陕A12345",
    createdDate: "2022/11/22 13:52:09",
    faultType: "元部件损坏",
    faultPart: "轴承",
    faultSituation: "异响",
    "carBrandType": "沃尔沃L220",
    repair_start_date: "2022/11/23 08:45:09",
    repair_end_date: "2022/11/23 16:52:09",
    manHour: 8.2,
    "creator": "张三",
    repairman_name: "王五",
    			"itemList": [
