  ...
  <div class="tablestyle">
    <div class="search">
      <el-col :span="3">
        <el-input
          class="w-10 m-2"
          v-model="searchvalue"
          placeholder="请输入车辆编号/车牌号/维修人员姓名"
        />
      </el-col>
    ...
    <div class="chartstyle">
      ...
      >
        ...
        <el-table-column  prop="userName" label="维修人员姓名" min-width="13%" />
        <el-table-column  prop="code" label="车辆编号" min-width="9%" />
        <el-table-column  prop="carNumber" label="车牌号" min-width="10%" />
        <el-table-column  prop="startTime" label="维修开始时间" min-width="20%" />
        <el-table-column  prop="endTime" label="维修结束时间" min-width="20%" />
        <el-table-column  prop="manHour" label="维修工时" min-width="9%" />
        <el-table-column  prop="repairStatus" label="维修状态" min-width="9%" />
        <template #empty>
...
import { getManHourAll as getManHourAll,queryRepManHour as queryRepManHour } from '@/api/index'
...
let tableData = [
  {
    ...
    code: 2,
    carNumber: "陕A12345",
    startTime: "2022-11-16 18:22:30",
    endTime: "2022-11-16 18:22:30",
    manHour: 8.5,
    repairStatus:'维修中'
  },
  {
...
const searchData = ()=>{
  ...
  let parmes = {
    ...
    queryRepManHour(parmes).then((res)=>{
      isloading.value = false;
      console.log(res)
      if(res.code === 200){
          let data = res.data;
